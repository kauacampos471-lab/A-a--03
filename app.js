...
const Financeiro = (() => {
  ...
  function renderChart() {
    ...
    const valores = dias.map(d => vendas.filter(v => new Date(v.dataHora).toDateString() === d.date.toDateString()).reduce((s, v) => s + v.total, 0));
